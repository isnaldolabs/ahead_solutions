...
ERROR - 2023-08-17 11:35:53 --> SELECT `us`.`user_id`, `us`.`email`, `us`.`nick_name`, `us`.`full_name`, `us`.`license_id_last`, `al`.`license_id`, `al`.`name` `license_name`, `al`.`short_name` `license_short_name`, `ag`.`name` `group_name`, `ag`.`is_admin`, `ul`.`season_id_last`, `se`.`name` `season_name`, `ap`.`lines_page`
FROM `auth_users` `us`
...
ERROR - 2023-08-17 12:20:07 --> Severity: Warning --> Undefined variable $search /Volumes/MacintoshHD/Projetos/Agro/Aplicacao/application/views/protocols/protocols/vw_protocols.php 702
