...
class ApplicationMode_model extends CI_Model {

  protected $main_table = 'application_modes';
  ...
  function get_by_key($psKey){
    $this->db->where('md5(mode_id)', $psKey);
    return $this->db->get($this->main_table)->result();
  }
