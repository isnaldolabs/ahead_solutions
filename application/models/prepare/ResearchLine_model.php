...
class ResearchLine_model extends CI_Model {

  protected $main_table = 'research_lines';
  ...
  function get_by_key($psKey){
    $this->db->where('md5(line_id)', $psKey);
    return $this->db->get($this->main_table)->result();
  }
