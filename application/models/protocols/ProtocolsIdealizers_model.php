...
class ProtocolsIdealizers_model extends CI_Model {

  protected $main_table = 'protocols_idealizers';
  ...
  function get_all($paParams){
    $this->db->select('a.id, a.license_id, a.protocol_id, a.idealizer_id, b.name idealizer_name');
    $this->db->from($this->main_table.' a');
    $this->db->join('teams b', '(b.license_id=a.license_id and b.team_id=a.idealizer_id)', 'left');
  ...
  function get_list_idealizers($paParams){
