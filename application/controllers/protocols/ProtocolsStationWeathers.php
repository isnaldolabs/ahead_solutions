...
class ProtocolsStationWeathers extends CI_Controller {

  protected $data = array();
  protected $link_redirect = RT_PROTOCOLS_STATION_WEATHERS;
  ...
  public function __construct(){
    ...
    fb_get_logged();
    $this->output->cache(0);
    $this->load->model('protocols/ProtocolsStationWeathers_model', 'ds_model');

    $this->data['view_title'] = 'Posto Metereologico';
    $this->data['view_title_rec'] = 'Posto Metereologico';
    $this->data['menu_active'] = MENU_PROTOCOLS;
    $this->data['link_delete'] = base_url(RT_PROTOCOLS_STATION_WEATHERS_DB_DEL);
    $this->data['link_insert'] = base_url(RT_PROTOCOLS_STATION_WEATHERS_VW_INS);
    $this->data['link_update'] = base_url(RT_PROTOCOLS_STATION_WEATHERS_VW_UPD);
  }
  ...
  public function index(){
    ...
    $this->load->view('protocols/protocols_station_weathers/vw_protocols_station_weathers');
  ...
  public function ct_vw_insert(){
    ...
    $this->load->view('patterns/v_header');
    $this->load->view('patterns/v_navigation', $this->data);
    $this->load->view('protocols/protocols_station_weathers/vw_protocols_station_weathers_ins', $this->data);
    $this->load->view('patterns/v_footer');
  }
