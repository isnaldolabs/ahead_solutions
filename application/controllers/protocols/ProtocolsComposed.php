...
class ProtocolsComposed extends CI_Controller {

  protected $data = array();
  protected $link_redirect = RT_PROTOCOLS_COMPOSED;
  ...
  public function __construct(){
    ...
    $this->data['link_delete'] = base_url(RT_PROTOCOLS_COMPOSED_DB_DEL);
    $this->data['link_insert'] = base_url(RT_PROTOCOLS_COMPOSED_VW_INS);
    $this->data['link_update'] = base_url(RT_PROTOCOLS_COMPOSED_VW_UPD);
  }
  ...
  public function ct_db_insert(){
    ...
    elseif(isset($_POST[BTN_POST_SAVE])){
      ...
      if($lbCheck==FALSE){
        self::flashErrors();
        redirect(base_url(RT_PROTOCOLS_COMPOSED_VW_INS));
      }else{
        self::saveRecord();
