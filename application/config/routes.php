...
define('RT_CALL_PROTOCOLS_FILTER_SEARCH','rt-call-protocols-filter-search');
$route[RT_CALL_PROTOCOLS_FILTER_SEARCH] = 'protocols/Protocols/ct_call_protocols_filter_search/';
