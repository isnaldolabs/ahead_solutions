...
?>
        <div class="my-3 my-md-5">
          <div class="container">
            ...
            <?php echo form_open(base_url(RT_ADMIN_GROUPS_DB_UPD.'/'.md5($input_group_id['value'])), array('id'=>'frm_upd')); ?>
              <div class="card">
                ...
                <div class="card-body">
                  <?php echo input_hidden($input_group_id); ?>
                  <?php echo input_name($input_name); ?>
                  <?php echo input_active($input_active); ?>
                  <?php echo input_active($input_is_admin); ?>
                </div>
