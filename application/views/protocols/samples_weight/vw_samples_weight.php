                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_WEIGHT)==ACCESS_LEVEL_COMPLETE){ ?>
                        <a href="<?php echo base_url(RT_CALL_INTEGRATIONS_SPL.'/'.SHD_SAMPLES_WEIGHT); ?>" class="btn btn-outline-secondary me-2">
                            <span class="me-1">
                            ...
                            <td colspan="8" style="padding: 0px !important;">
                                <table class="table table-hover table-responsive-sm small bg-white">
                                  ...
                                  <tbody>
                                    ...
                                    $lo_sample = fo_get_sample_weight($la_params);
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end text-muted"><?php echo $row_sample->num_weight; ?></td>
                                        <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_WEIGHT)==ACCESS_LEVEL_COMPLETE){ ?>
                                        <td class="text-end">
                                            <a class="text-blue me-2" href="<?php echo $link_update."/".md5($row_sample->weight_id); ?>">
                                            ...
                                            <a href="javascript:void(0)"
                                               ...
                                               data-key="<?php echo $link_delete."/".md5($row_sample->weight_id); ?>"
                                               data-code="<?php echo fdDateMySQL_to_DateBr($row_sample->dt_sample); ?>"
                                               data-name="<?php echo 'Rua/Linha '.$row_sample->spot_id; ?>"
                                               data-desc="" >
