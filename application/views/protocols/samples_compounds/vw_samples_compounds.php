                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_COMPOUNDS)==ACCESS_LEVEL_COMPLETE){ ?>
                        <a href="<?php echo base_url(RT_CALL_INTEGRATIONS_SPL.'/'.SHD_SAMPLES_COMPOUNDS); ?>" class="btn btn-outline-secondary me-2">
                            <span class="me-1">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover card-table table-vcenter text-nowrap" id="task-table">
                      ...
                      <tbody>
                        ...
                        <!--amostras dos compostos de cada parcela/tratamento-->
                        <tr>
                            <td colspan="9" style="padding: 0px !important;">
                                <table class="table table-hover table-responsive-sm small bg-white">
                                  <thead>
                                    <tr>
                                        <th colspan="3" scope="col" class="text-start">Composto</th>
                                        <th scope="col" class="text-center">Data</th>
                                        <th scope="col" class="text-center">Ponto</th>
                                        <th scope="col" class="text-end">Valor</th>
                                        <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_COMPOUNDS)==ACCESS_LEVEL_COMPLETE){ ?>
                                            <th scope="col" class="text-end">
                                                <a class="text-blue me-2" href="<?php echo $link_insert."/".$row->sketch_id.'/'.$row->treatment_id; ?>">
                                                    <span class="me-1">
                                  ...
                                  <tbody>
                                    ...
                                    $lo_sample = fo_get_sample_compounds($la_params);
                                    foreach ($lo_sample as $row_sample){
                                    ?>
                                    <tr>
                                        <td class="text-start"><?php echo $row_sample->compound_id; ?></td>
                                        <td class="text-start"><?php echo $row_sample->compound_name; ?></td>
                                        <td class="text-start"><?php echo $row_sample->compound_short_name; ?></td>
                                        ...
                                        <td class="text-end"><?php echo $row_sample->num_compound; ?></td>
                                        <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_COMPOUNDS)==ACCESS_LEVEL_COMPLETE){ ?>
                                        <td class="text-end">
                                            <a class="text-blue me-2" href="<?php echo $link_update."/".md5($row_sample->sample_id).'/'.$row->treatment_id; ?>">
                                            ...
                                            <a href="javascript:void(0)"
                                               ...
                                               data-desc="<?php echo 'Composto '.$row_sample->compound_name; ?>" >
