...
?>
        <div class="my-3 my-md-5">
          <div class="container">
            ...
            <?php echo form_open(base_url(RT_SAMPLES_HOLES_DB_UPD.'/'.md5($input_hole_id['value'])), array('id'=>'frm_upd')); ?>
              <div class="card">
