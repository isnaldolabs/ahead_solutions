                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_HOLES)==ACCESS_LEVEL_COMPLETE){ ?>
                        <a href="<?php echo base_url(RT_CALL_INTEGRATIONS_SPL.'/'.SHD_SAMPLES_HOLES); ?>" class="btn btn-outline-secondary me-2">
                            <span class="me-1">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover card-table table-vcenter text-nowrap" id="task-table">
                      ...
                      <tbody>
                        ...
                        <!--amostras de perfurados de cada parcela-->
                        <tr>
                                ...
                                <table class="table table-hover table-responsive-sm small bg-white">
                                  <thead>
                                    <tr>
                                      ...
                                      <th scope="col" class="text-end">Perfurados</th>
                                      <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_HOLES)==ACCESS_LEVEL_COMPLETE){ ?>
                                  ...
                                  <tbody>
                                    ...
                                    $lo_sample = fo_get_sample_holes($la_params);
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end text-muted"><?php echo $row_sample->num_hole; ?></td>
                                        <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_HOLES)==ACCESS_LEVEL_COMPLETE){ ?>
                                        <td class="text-end">
                                            <a class="text-blue me-2" href="<?php echo $link_update."/".md5($row_sample->hole_id); ?>">
                                            ...
                                            <a href="javascript:void(0)"
                                               ...
                                               data-key="<?php echo $link_delete."/".md5($row_sample->hole_id); ?>"
