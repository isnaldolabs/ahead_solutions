...
?>
        <div class="my-3 my-md-5">
          <div class="container">
            ...
            <?php echo form_open(base_url(RT_SAMPLES_PITH_DB_UPD.'/'.md5($input_pith_id['value'])), array('id'=>'frm_upd')); ?>
              <div class="card">
