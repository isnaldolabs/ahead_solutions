                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if ((fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_VARIABLES)==ACCESS_LEVEL_COMPLETE) and ($li_total_rows < 1)){ ?>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover card-table table-vcenter text-nowrap" id="task-table">
                      <thead>
                        <tr role="row">
                          <th>Nome</th>
                          <?php if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_VARIABLES)==ACCESS_LEVEL_COMPLETE){ ?>
                          ...
                          <?php if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_VARIABLES)==ACCESS_LEVEL_COMPLETE){ ?>
                            <td class="text-end">
                              <a href="javascript:void(0)"
                                 ...
                                 data-code=""
                                 data-name="<?php echo $row->variable_name; ?>"
                                 data-desc="" >
