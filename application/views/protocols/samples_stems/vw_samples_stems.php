                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_STEMS)==ACCESS_LEVEL_COMPLETE){ ?>
                        <a href="<?php echo base_url(RT_CALL_INTEGRATIONS_SPL.'/'.SHD_SAMPLES_STEMS); ?>" class="btn btn-outline-secondary me-2">
                            <span class="me-1">
                                ...
                                <table class="table table-hover table-responsive-sm small bg-white">
                                  <thead>
                                    <tr>
                                      ...
                                      <th scope="col" class="text-end">Metros</th>
                                      <th scope="col" class="text-end">Colmos por Metro</th>
                                      <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_STEMS)==ACCESS_LEVEL_COMPLETE){ ?>
                                  ...
                                  <tbody>
                                    ...
                                    $lo_sample = fo_get_sample_stems($la_params);
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end"><?php echo $row_sample->num_stems; ?></td>
                                        <td class="text-end text-muted"><?php echo $row_sample->meters; ?></td>
                                        <td class="text-end text-muted"><?php echo frDecimals($row_sample->num_stems_meter,2); ?></td>
                                        <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_STEMS)==ACCESS_LEVEL_COMPLETE){ ?>
                                        <td class="text-end">
                                            <a class="text-blue me-2" href="<?php echo $link_update."/".md5($row_sample->stem_id); ?>">
                                            ...
                                            <a href="javascript:void(0)"
                                               ...
                                               data-key="<?php echo $link_delete."/".md5($row_sample->stem_id); ?>"
