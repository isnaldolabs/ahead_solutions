                    ...
                    <div class="col-sm-6 col-lg-12">
                        <div class="card">
                            ...
                            <table class="table card-table">
                                <thead>
                                    <th>Causas ou fontes de Variação</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Tratamentos (entre grupos)</td>
                                        ...
                                        <td class="h4 text-center"><?php echo frDecimals($lr_anova_fcalc,3); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Erro ou resíduo (dentro de grupos)</td>
