...
?>
        <div class="my-3 my-md-5">
          <div class="container">
            ...
            <?php echo form_open(base_url(RT_SAMPLES_DAMAGES_DB_UPD.'/'.md5($input_damage_id['value'])), array('id'=>'frm_upd')); ?>
              <div class="card">
