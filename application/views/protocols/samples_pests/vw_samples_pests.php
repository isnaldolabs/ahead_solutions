                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_PESTS)==ACCESS_LEVEL_COMPLETE){ ?>
                        <a href="<?php echo base_url(RT_CALL_INTEGRATIONS_SPL.'/'.SHD_SAMPLES_PESTS); ?>" class="btn btn-outline-secondary me-2">
                            <span class="me-1">
                                ...
                                <table class="table table-hover table-responsive-sm small bg-white">
                                  <thead>
                                    <tr>
                                      ...
                                      <th scope="col" class="left-right">Praga</th>
                                      <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_PESTS)==ACCESS_LEVEL_COMPLETE){ ?>
                                  ...
                                  <tbody>
                                    ...
                                    $lo_sample = fo_get_sample_pests($la_params);
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-start"><?php echo $row_sample->pest_name; ?></td>
                                        <?php if (fiLevelAccess(fi_get_user(), FNC_SAMPLES_PESTS)==ACCESS_LEVEL_COMPLETE){ ?>
                                        <td class="text-end">
                                            <a href="javascript:void(0)"
                                               ...
                                               data-desc="<?php echo 'Praga '.$row_sample->pest_name; ?>" >
