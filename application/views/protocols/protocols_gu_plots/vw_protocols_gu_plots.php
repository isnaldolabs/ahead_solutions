                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_GU_PLOTS)==ACCESS_LEVEL_COMPLETE){ ?>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td>
                              ...
                              <div class="small text-muted">
                                Plantio: <?php echo fdDateMySQL_to_DateBr($row->dt_planting); ?>
                                <span class="ml-5">
                                  <?php if($row->dt_cutting != NULL){ ?>
                                      Último Corte: <?php echo fdDateMySQL_to_DateBr($row->dt_cutting); ?>
                                  <?php } ?>
                                </span>
                              </div>
                          </td>
                          ...
                          <td class="text-end"><?php echo frDecimals($row->total_area,1); ?></td>
                          <?php if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_GU_PLOTS)==ACCESS_LEVEL_COMPLETE){ ?>
                            <td class="text-end">
                              <a href="javascript:void(0)"
                                 ...
                                 data-code="<?php echo $row->block_code.' - '.$row->plot_code; ?>"
                                 data-name="<?php echo $row->farm_code.' - '.$row->farm_name; ?>"
                                 data-desc="" >
