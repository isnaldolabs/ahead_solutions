                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_NOTES)==ACCESS_LEVEL_COMPLETE){ ?>
                        <a href="<?php echo $link_insert; ?>" class="btn btn-primary btn-sm me-2">
                            <span class="me-1">
                    ...
                    <table class="table table-hover card-table table-vcenter" id="task-table">
                      ...
                      <tbody>
                        ...
                        <tr role="row" class="odd">
                          <td class="text-center"><?php echo fdDateMySQL_to_DateBr($row->note_at); ?></td>
                          <td><?php echo $row->user_name; ?></td>
                          <td><?php echo substr($row->notes, 0, 80).'[...]'; ?></td>
                          <?php if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_NOTES)==ACCESS_LEVEL_COMPLETE){ ?>
                            <td class="text-end">
                                <a class="text-blue me-2" href="<?php echo $link_update."/".md5($row->note_id); ?>">
                                ...
                                <a href="javascript:void(0)"
                                   ...
                                   data-key="<?php echo $link_delete."/".md5($row->note_id); ?>"
                                   data-code="<?php echo $row->notes; ?>"
                                   data-name=""
                                   data-desc="" >
                        ...
                        <?php
                          if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_NOTES)==ACCESS_LEVEL_COMPLETE){
                            echo fsModalDelete($row->note_id);
                          }
                        ?>
