                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_VARIETIES)==ACCESS_LEVEL_COMPLETE){ ?>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover card-table table-vcenter text-nowrap" id="task-table">
                      ...
                      <tbody>
                          ...
                          <?php if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_VARIETIES)==ACCESS_LEVEL_COMPLETE){ ?>
                            <td class="text-end">
                              <a href="javascript:void(0)"
                                 ...
                                 data-code=""
                                 data-name="<?php echo $row->variety_name; ?>"
                                 data-desc="" >
                        ...
                        <?php
                          if (fiLevelAccess(fi_get_user(), FNC_PROTOCOLS_VARIETIES)==ACCESS_LEVEL_COMPLETE){
