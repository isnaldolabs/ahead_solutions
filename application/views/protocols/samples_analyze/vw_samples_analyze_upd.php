...
?>
        <div class="my-3 my-md-5">
          <div class="container">
            ...
            <?php echo form_open(base_url(RT_SAMPLES_ANALYZE_DB_UPD.'/'.md5($input_analyze_id['value'])), array('id'=>'frm_upd')); ?>
              <div class="card">
                ...
                <div class="card-body">
                  <?php echo input_hidden($input_analyze_id); ?>
                  ...
                  <?php echo input_value($input_num_brix); ?>
                  <?php echo input_value($input_num_lai); ?>
                  <?php echo input_value($input_num_pbu); ?>
                </div>
