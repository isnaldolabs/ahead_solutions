                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_PRODUCTS)==ACCESS_LEVEL_COMPLETE){ ?>
                    ...
                    <table class="table table-hover card-table table-vcenter text-nowrap" id="task-table">
                      ...
                      <tbody>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td class="text-muted"><?php echo $row->measure_name; ?></td>
                          <td><?php echo $row->group_name; ?></td>
                          <?php if (fiLevelAccess(fi_get_user(), FNC_PRODUCTS)==ACCESS_LEVEL_COMPLETE){ ?>
                            <td class="text-end">
                              <a class="text-blue me-2" href="<?php echo $link_update."/".md5($row->product_id); ?>">
                              ...
                              <a href="javascript:void(0)"
                                 ...
                                 data-key="<?php echo $link_delete."/".md5($row->product_id); ?>"
                                 data-code="<?php echo $row->product_id; ?>"
                        ...
                        <?php
                          if (fiLevelAccess(fi_get_user(), FNC_PRODUCTS)==ACCESS_LEVEL_COMPLETE){
                            echo fsModalDelete($row->product_id);
                          }
                        ?>
