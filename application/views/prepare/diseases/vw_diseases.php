                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_DISEASES)==ACCESS_LEVEL_COMPLETE){ ?>
                    ...
                    <table class="table table-hover card-table table-vcenter text-nowrap" id="task-table">
                      ...
                      <tbody>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <?php if (fiLevelAccess(fi_get_user(), FNC_DISEASES)==ACCESS_LEVEL_COMPLETE){ ?>
                            <td class="text-end">
                              <a class="text-blue me-2" href="<?php echo $link_update."/".md5($row->disease_id); ?>">
                              ...
                              <a href="javascript:void(0)"
                                 ...
                                 data-key="<?php echo $link_delete."/".md5($row->disease_id); ?>"
                                 data-code="<?php echo $row->disease_id; ?>"
                        ...
                        <?php
                          if (fiLevelAccess(fi_get_user(), FNC_DISEASES)==ACCESS_LEVEL_COMPLETE){
                            echo fsModalDelete($row->disease_id);
                          }
                        ?>
