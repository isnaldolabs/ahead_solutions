                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-options">
                      <?php if (fiLevelAccess(fi_get_user(), FNC_SEASONS)==ACCESS_LEVEL_COMPLETE){ ?>
                    ...
                    <table class="table table-hover card-table table-vcenter text-nowrap" id="task-table">
                      ...
                      <tbody>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td class="text-center"><?php echo fdDateMySQL_to_DateBr($row->dt_start); ?></td>
                          <td class="text-center"><?php echo fdDateMySQL_to_DateBr($row->dt_end); ?></td>
                          <?php if (fiLevelAccess(fi_get_user(), FNC_SEASONS)==ACCESS_LEVEL_COMPLETE){ ?>
                            <td class="text-end">
                              <a class="text-blue me-2" href="<?php echo $link_update."/".md5($row->season_id); ?>">
                              ...
                              <a href="javascript:void(0)"
                                 ...
                                 data-key="<?php echo $link_delete."/".md5($row->season_id); ?>"
                                 data-code="<?php echo $row->num_year; ?>"
                        ...
                        <?php
                          if (fiLevelAccess(fi_get_user(), FNC_SEASONS)==ACCESS_LEVEL_COMPLETE){
                            echo fsModalDelete($row->season_id);
                          }
                        ?>
