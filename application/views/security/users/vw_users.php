                      ...
                      <tbody>
                        <?php foreach ($dataset as $row){ ?>
                            <tr role="row" class="odd">
                              ...
                              <td class="text-end">
                                <a class="text-blue me-2" href="<?php echo $link_update."/".md5($row->user_id); ?>">
                                ...
                                <a href="javascript:void(0)"
                                   ...
                                   data-key="<?php echo $link_delete."/".md5($row->user_id); ?>"
                                   data-code="<?php echo $row->email; ?>"
                                   data-name="<?php echo $row->nick_name; ?>"
                                   data-desc="" >
                            ...
                            <?php echo fsModalDelete($row->user_id); ?>
                        <?php } ?>
                      </tbody>
                    </table>
                  </div>
